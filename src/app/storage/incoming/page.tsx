...
export default function StorageIncomingPage() {
  ...
  const filteredStorages = useMemo(() => {
    let filtered = [...allStorages.filter((s) => s.status === "pending" || s.status === "stored")];
  ...
  }, [allStorages, searchInput.debouncedValue, statusTab, locationTab, dateRange, showAllDates, searchInput]);
