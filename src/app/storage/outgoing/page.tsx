...
export default function StorageOutgoingPage() {
  ...
  const loadData = async () => {
    ...
    const { data: storagesData } = await supabase
      ...
      .select("*")
      .eq("status", "stored") // 픽업 관리는 보관중 상태만
      ...
      >
        ...
        <TabsContent value="all" className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 space-y-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-500">(모든 터미널)</span>
            </div>
            ...
            <div className="text-sm text-gray-600">
              총 {filteredStorages.length}개의 픽업 예정 건
            </div>
          </div>
        ...
        <TabsContent value="T1" className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 space-y-4">
            ...
            <div className="text-sm text-gray-600">
              총 {filteredStorages.length}개의 터미널1 픽업 예정 건
            </div>
          </div>
        ...
        <TabsContent value="T2" className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 space-y-4">
            ...
            <div className="text-sm text-gray-600">
              총 {filteredStorages.length}개의 터미널2 픽업 예정 건
            </div>
          </div>
